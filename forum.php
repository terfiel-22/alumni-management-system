    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">Program & Event</h3>
                <hr class="divider my-4" />
                <?php
                $login_id =  $_SESSION['login_id'];
                $officer = $conn->query("SELECT o.*,a.id from alumnus_bio a inner join officers o on a.id = o.alumnus_bio_id WHERE a.id = $login_id");
                if ($officer->num_rows >= 1) :
                ?>
                    <div class="row col-md-12 mb-2 justify-content-center">
                        <button class="btn btn-primary btn-block col-sm-4" type="button" id="new_forum"><i class="fa fa-plus"></i> Create New event</button>
                    </div>
                <?php endif; ?>
            </div>
