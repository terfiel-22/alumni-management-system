											...
											<center>
												<div class="btn-group">
													...
													<div class="dropdown-menu">
														<a class="dropdown-item" href="assets/uploads/documents/<?php echo $row['id'] ?>_document.<?php echo $row['file_extension'] ?>" target="_blank">Download</a>
...
<script>
	...
	$('#new_document').click(function() {
		uni_modal("New Entry", "manage_document.php")
	})
