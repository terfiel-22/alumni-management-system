...
<body id="page-top">
    ...
    <div class="container">
      <a class="navbar-brand" href="">
        <div class="row align-items-center" style="line-height:10px;">
          <img src="admin/assets/img/luga.png" alt="..." height="36">
          <span style="font-size: x-small;margin-left:5px">LUGA <br>NATIONAL HIGH<br> SCHOOL</span>
        </div>
      </a>
      <ul class="navbar-nav ml-auto my-2 my-lg-0">
        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=home">Home</a></li>
        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=alumni_list">Alumni Stories</a></li>

        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=gallery">Gallery</a></li>
        <?php if (isset($_SESSION['login_id'])) : ?>
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=careers">Career Opportinity</a></li>
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=forum">Program & Events</a></li>
        <?php endif; ?>
  ...
  <footer class=" py-5">
    ...
    <br>
    <div class="container">
      <div class="small text-center text-muted">Copyright © 2023 - LNHS </a></div>
    </div>
  </footer>
