                        ...
                        <form action="" id="update_account">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="employment_status" class="custom-select">
                                        <option <?php echo $_SESSION['bio']['employment_status'] == 'Employed' ? 'selected' : '' ?>>Employed</option>
                                        <option <?php echo $_SESSION['bio']['employment_status'] == 'Unemployed' ? 'selected' : '' ?>>Unemployed</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-5">
                                    <label for="" class="control-label">Share your Stories</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control" name="email" value="<?php echo $_SESSION['bio']['email'] ?>" readonly>
                                </div>
                                <div class="col-md-4">
